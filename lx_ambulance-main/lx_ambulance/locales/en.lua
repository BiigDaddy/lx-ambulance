Locales['en'] = {
  ...
  ['vehicleshop_bought'] = 'you have bought  for %',
  ...
  ['revive_complete_award'] = 'you have revived  and earned !',
  ['heal_inprogress'] = 'you are healing!',
  ['heal_complete'] = 'you have healed ',
  ...
  ['respawn_bleedout_in'] = 'Bleed Out: ~b~%s minutes %s seconds~s~\n',
  ['respawn_bleedout_prompt'] = 'Continue to wait for EMS, or hold [~g~E~s~] to respawn and LOSE ALL ITEMS , if no EMS available, type /aimedic',
  ['respawn_bleedout_fine'] = 'Continue to wait for EMS, or hold [~g~E~s~] to respawn for ~b~$%s~s~ and ~r~LOSE ALL ITEMS.~s~ , if no EMS available, type /aimedic',
  ...
  ['combatlog_message'] = 'You have been spawned dead. You were dead when you left the server.',
  -- Revive
